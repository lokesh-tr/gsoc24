...
1. Achieving Semantic Functionality (jump-to-definition, quick help on hover, syntax highlighting, etc.):
   ...
   - We can use the source file's build arguments as arguments of the reference documents to trick sourcekitd to provide Semantic Functionality for the reference documents.
...
20. Add Semantic Functionality to Macro Expansion Reference Documents (including Nested Macro Expansion) 🚦 [#1610](https://github.com/swiftlang/sourcekit-lsp/pull/1610) (Explored a variety of ideas everything took shape into #1631, last commit squashed previous ideas by the way) - Closed in favour of #1631
